...
I have an idea to improve my understanding in AI by modifying the checkers game from another repo and improve the AI using minimax algorithm and alpha-beta pruning optimizatizion. This is also my group project in AI class. 
...
## Credits
https://github.com/lucaskenji/python-checkers.git - base design
